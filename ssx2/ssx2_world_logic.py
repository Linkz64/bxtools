...
class LogicDraw:
	...
	def draw_emitter(self, layout, index):
		...
		col.prop(effect, "u10", text="U10")
		col.prop(effect, "u11", text="U11")
		col.prop(effect, "u12", text="U12")
		col.prop(effect, "u13", text="U13")
		col.prop(effect, "u14", text="U14")
		col.prop(effect, "u15", text="U15")
		col.prop(effect, "u16", text="U16")
		col.prop(effect, "u17", text="U17")
		col.prop(effect, "u18", text="U18")
		col.prop(effect, "u19", text="U19")
		col.prop(effect, "u20", text="U20")
		col.prop(effect, "u21", text="U21")
		col.prop(effect, "u22", text="U22")
		col.prop(effect, "u23", text="U23")
		col.prop(effect, "u24", text="U24")
		col.prop(effect, "u25", text="U25")
		col.prop(effect, "u26", text="U26")
		col.prop(effect, "u27", text="U27")
		col.prop(effect, "u28", text="U28")
		col.prop(effect, "u29", text="U29")
		col.prop(effect, "u30", text="U30")
		col.prop(effect, "u31", text="U31")
		col.prop(effect, "u32", text="U32")
		col.prop(effect, "u33", text="U33")
		col.prop(effect, "u34", text="U34")
		col.prop(effect, "u35", text="U35")
		col.prop(effect, "u36", text="U36")
		col.prop(effect, "u37", text="U37")
		col.prop(effect, "u38", text="U38")
		col.prop(effect, "u39", text="U39")
		col.prop(effect, "u40", text="U40")
		col.prop(effect, "u41", text="U41")
		col.prop(effect, "u42", text="U42")
		col.prop(effect, "u43", text="U43")
		col.prop(effect, "u44", text="U44")
		col.prop(effect, "u45", text="U45")
		col.prop(effect, "u46", text="U46")
		col.prop(effect, "u47", text="U47")
		col.prop(effect, "u48", text="U48")
		col.prop(effect, "u49", text="U49")
		col.prop(effect, "u50", text="U50")
