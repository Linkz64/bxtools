...
class LogicImporters:
	...
	def import_flag(self, seq, json_fx):
		fx_index = len(self.effects.flag)

		fx = self.effects.flag.add()
		json_fx = json_fx["type0"]["type0Sub13"]
		fx.u0 = json_fx["U0"]
		fx.u1 = json_fx["U1"]
		fx.u2 = json_fx["U2"]
		fx.u3 = json_fx["U3"]
	...
	def import_cracked(self, seq, json_fx):
		fx_index = len(self.effects.cracked)

		fx = self.effects.cracked.add()
		json_fx = json_fx["type0"]["type0Sub14"]
		fx.u0 = json_fx["U0"]
		fx.u1 = json_fx["U1"]
...
class LogicDraw:
	...
	def draw_roller(self, layout, index):
		...
		col.prop(effect, "u2", text="U2")
		col.prop(effect, "u3", text="U3")
		col.prop(effect, "u4", text="U4")
		col.prop(effect, "u5", text="U5")
	...
	def draw_flag(self, layout, index):
		...
		col = layout.column()
		col.prop(effect, "checked", text="Flag")
		col.prop(effect, "u0", text="U0")
		col.prop(effect, "u1", text="U1")
		col.prop(effect, "u2", text="U2")
		col.prop(effect, "u3", text="U3")

	def draw_cracked(self, layout, index):
		effect = self.effects.cracked[index]
		layout.label(text="", icon='MOD_PHYSICS')
		layout.prop(effect, "checked", text="Cracked")
	...
	def draw_mesh_anim(self, layout, index):
		...
		col.prop(effect, "u5", text="U5")
		col.prop(effect, "u6", text="U6")
		col.prop(effect, "u7", text="U7")
		col.prop(effect, "u8", text="U8")
		col.prop(effect, "u9", text="U9")
	...
	def draw_end_boost(self, layout, index):
		...
		col.prop(effect, "u16", text="U16")
		col.prop(effect, "u17", text="U17")
		col.prop(effect, "u18", text="U18")
	...
	def draw_anim_combo(self, layout, index):
		...
		col.prop(effect, "u8", text="U8")
		col.prop(effect, "u9", text="U9")
		col.prop(effect, "u10", text="U10")
		col.prop(effect, "u11", text="U11")
	...
	def draw_emitter(self, layout, index):
		...
		gf = layout.grid_flow()
		gf.prop(effect, "checked", text="Emitter")
		gf.prop(effect, "u0", text="U0")
		gf.prop(effect, "u1", text="U1")
		gf.prop(effect, "u2", text="U2")
		gf.prop(effect, "u3", text="U3")
		gf.prop(effect, "u4", text="U4")
		gf.prop(effect, "u5", text="U5")
		gf.prop(effect, "u6", text="U6")
		gf.prop(effect, "u7", text="U7")
		gf.prop(effect, "u8", text="U8")
		gf.prop(effect, "u9", text="U9")
		gf.prop(effect, "u10", text="U10")
		gf.prop(effect, "u11", text="U11")
		gf.prop(effect, "u12", text="U12")
		gf.prop(effect, "u13", text="U13")
		gf.prop(effect, "u14", text="U14")
		gf.prop(effect, "u15", text="U15")
		gf.prop(effect, "u16", text="U16")
		gf.prop(effect, "u17", text="U17")
		gf.prop(effect, "u18", text="U18")
		gf.prop(effect, "u19", text="U19")
		gf.prop(effect, "u20", text="U20")
		gf.prop(effect, "u21", text="U21")
		gf.prop(effect, "u22", text="U22")
		gf.prop(effect, "u23", text="U23")
		gf.prop(effect, "u24", text="U24")
		gf.prop(effect, "u25", text="U25")
		gf.prop(effect, "u26", text="U26")
		gf.prop(effect, "u27", text="U27")
		gf.prop(effect, "u28", text="U28")
		gf.prop(effect, "u29", text="U29")
		gf.prop(effect, "u30", text="U30")
		gf.prop(effect, "u31", text="U31")
		gf.prop(effect, "u32", text="U32")
		gf.prop(effect, "u33", text="U33")
		gf.prop(effect, "u34", text="U34")
		gf.prop(effect, "u35", text="U35")
		gf.prop(effect, "u36", text="U36")
		gf.prop(effect, "u37", text="U37")
		gf.prop(effect, "u38", text="U38")
		gf.prop(effect, "u39", text="U39")
		gf.prop(effect, "u40", text="U40")
		gf.prop(effect, "u41", text="U41")
		gf.prop(effect, "u42", text="U42")
		gf.prop(effect, "u43", text="U43")
		gf.prop(effect, "u44", text="U44")
		gf.prop(effect, "u45", text="U45")
		gf.prop(effect, "u46", text="U46")
		gf.prop(effect, "u47", text="U47")
		gf.prop(effect, "u48", text="U48")
		gf.prop(effect, "u49", text="U49")
		gf.prop(effect, "u50", text="U50")
...
LogicDraw.effect_drawers = {
	...
	"cracked": LogicDraw.draw_cracked,
...
class SSX2_PG_WorldEffects(PropertyGroup):
	...
	cracked: CollectionProperty(type=SSX2_PG_WorldEffectCracked)
...
class SSX2_OP_LogicDeleteScript(Operator):
	...
	bl_description = 'Delete this script'
	bl_options = {'UNDO'}
	...
	def execute(self, context):
		...
		if is_named_script:
			scripts = scene.ssx2_LogicNamedScripts
		else:
