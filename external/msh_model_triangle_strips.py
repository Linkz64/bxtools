"""
This contains a modified version of msh_model_traingle_strips.py

SOURCE: https://github.com/PrismaticFlower/SWBF-msh-Blender-IO/
LICENSE INFO: Licensed under Apache License 2.0 https://github.com/PrismaticFlower/SWBF-msh-Blender-IO/blob/master/license
